	...
	<tbody>
		...
		while ($dt_histori=mysqli_fetch_array($qry_histori)) {
			...
			if (mysqli_num_rows($qry_cek_kembali)>0) {
				...
				$status_kembali="<a href='pengembalian.php?id=".$dt_histori['id_peminjaman_buku']."'class='btn btn-warning' onclick='return confirm(\"Yakin ingin mengembalikan?\")'>Kembalikan</a>";
			}
		?>
			<tr>
